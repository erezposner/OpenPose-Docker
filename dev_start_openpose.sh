#!/bin/sh
# Varibles to edit
#LOCAL_SRC_DIR=/home/user3/repos/FaceGeometryTorch
#LOCAL_DATA_DIR=/home/user3/repos/data

LOCAL_SRC_DIR=/home/user3/repos/playing_smplifyx
LOCAL_DATA_DIR=/mnt/datasets/DVP
LOCAL_OP=/home/user3/repos/openpose
#Build
...
docker run --rm -p 8091:8091 -v $LOCAL_OP:/workspace/local_op -v $LOCAL_SRC_DIR:/workspace/local_station -v $LOCAL_DATA_DIR:/workspace/local_data --name openpose --gpus all --shm-size=1g --ulimit memlock=-1 -it openpose
